...
#define __PYX_HAVE__fast_likelihood
#define __PYX_HAVE_API__fast_likelihood
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "numpy/arrayobject.h"
#include "numpy/ufuncobject.h"
#include "fast_likelihood_threaded.cpp"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
struct __pyx_opt_args_15fast_likelihood_gmm_likelihood;

/* "fast_likelihood.pyx":11
...
/* Module declarations from 'fast_likelihood' */
static PyObject *__pyx_f_15fast_likelihood_gmm_likelihood(PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_15fast_likelihood_gmm_likelihood *__pyx_optional_args); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "fast_likelihood"
extern int __pyx_module_is_main_fast_likelihood;
int __pyx_module_is_main_fast_likelihood = 0;

/* Implementation of 'fast_likelihood' */
...
static const char __pyx_k_covars[] = "covars";
...
static const char __pyx_k_Dimension_mismatch_feature_dimen[] = "Dimension mismatch: feature dimensionality";
static const char __pyx_k_Dimension_mismatch_number_of_mix[] = "Dimension mismatch: number of mixtures";
static const char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static const char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static const char __pyx_k_ndarray_is_not_Fortran_contiguou[] = "ndarray is not Fortran contiguous";
static const char __pyx_k_numpy_core_umath_failed_to_impor[] = "numpy.core.umath failed to import";
static const char __pyx_k_Format_string_allocated_too_shor_2[] = "Format string allocated too short.";
static PyObject *__pyx_kp_s_Dimension_mismatch_feature_dimen;
static PyObject *__pyx_kp_s_Dimension_mismatch_number_of_mix;
...
static PyObject *__pyx_pf_15fast_likelihood_gmm_likelihood(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_means, PyArrayObject *__pyx_v_covars, PyArrayObject *__pyx_v_weights, PyObject *__pyx_v_n_jobs); /* proto */
...
static PyObject *__pyx_pw_15fast_likelihood_1gmm_likelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_15fast_likelihood_gmm_likelihood(PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_means, PyArrayObject *__pyx_v_covars, PyArrayObject *__pyx_v_weights, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_15fast_likelihood_gmm_likelihood *__pyx_optional_args) {
  PyObject *__pyx_v_n_jobs = ((PyObject *)__pyx_int_1);
  int __pyx_v_n_samples;
  int __pyx_v_n_mixtures;
  ...
  int __pyx_t_4;
  __Pyx_RefNannySetupContext("gmm_likelihood", 0);
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_n_jobs = __pyx_optional_args->n_jobs;
    }
  }
  ...
  __pyx_pybuffernd_weights.rcbuffer = &__pyx_pybuffer_weights;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_X.diminfo[1].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_X.diminfo[1].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_means.rcbuffer->pybuffer, (PyObject*)__pyx_v_means, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  __pyx_pybuffernd_means.diminfo[0].strides = __pyx_pybuffernd_means.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_means.diminfo[0].shape = __pyx_pybuffernd_means.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_means.diminfo[1].strides = __pyx_pybuffernd_means.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_means.diminfo[1].shape = __pyx_pybuffernd_means.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_covars.rcbuffer->pybuffer, (PyObject*)__pyx_v_covars, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  __pyx_pybuffernd_covars.diminfo[0].strides = __pyx_pybuffernd_covars.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_covars.diminfo[0].shape = __pyx_pybuffernd_covars.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_covars.diminfo[1].strides = __pyx_pybuffernd_covars.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_covars.diminfo[1].shape = __pyx_pybuffernd_covars.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_weights.rcbuffer->pybuffer, (PyObject*)__pyx_v_weights, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
 ...
 *     cdef double prob
 */
  __pyx_v_n_mixtures = (__pyx_v_weights->dimensions[0]);
 ...
 * 
 */
  __pyx_t_2 = ((__pyx_v_n_features != (__pyx_v_means->dimensions[1])) != 0);
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_2 = ((__pyx_v_n_features != (__pyx_v_covars->dimensions[1])) != 0);
  __pyx_t_1 = __pyx_t_2;
  __pyx_L4_bool_binop_done:;
  if (unlikely(__pyx_t_1)) {

    /* "fast_likelihood.pyx":19
 * 
 *     if n_features != means.shape[1] or n_features != covars.shape[1]:
 *         raise ValueError('Dimension mismatch: feature dimensionality')             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_2 = ((__pyx_v_n_mixtures != (__pyx_v_means->dimensions[0])) != 0);
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L7_bool_binop_done;
  }
  __pyx_t_2 = ((__pyx_v_n_mixtures != (__pyx_v_covars->dimensions[0])) != 0);
  __pyx_t_1 = __pyx_t_2;
  __pyx_L7_bool_binop_done:;
  if (unlikely(__pyx_t_1)) {

    /* "fast_likelihood.pyx":22
 * 
 *     if n_mixtures != means.shape[0] or n_mixtures != covars.shape[0]:
 *         raise ValueError('Dimension mismatch: number of mixtures')             # <<<<<<<<<<<<<<
 * 
 ...
 *     return prob
 */
  __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_n_jobs); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L1_error)

  /* "fast_likelihood.pyx":24
 *         raise ValueError('Dimension mismatch: number of mixtures')
 * 
 *     prob = data_logprob_threaded(<double*> X.data, <double*> means.data, <double*> covars.data, <double*> weights.data,             # <<<<<<<<<<<<<<
 *                 n_samples, n_mixtures, n_features, n_jobs)
 * 
 */
  __pyx_v_prob = data_logprob_threaded(((double *)__pyx_v_X->data), ((double *)__pyx_v_means->data), ((double *)__pyx_v_covars->data), ((double *)__pyx_v_weights->data), __pyx_v_n_samples, __pyx_v_n_mixtures, __pyx_v_n_features, __pyx_t_4);

  /* "fast_likelihood.pyx":27
 *                 n_samples, n_mixtures, n_features, n_jobs)
 * 
 *     return prob             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_prob); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("fast_likelihood.gmm_likelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_15fast_likelihood_1gmm_likelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_15fast_likelihood_1gmm_likelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("gmm_likelihood (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_X,&__pyx_n_s_means,&__pyx_n_s_covars,&__pyx_n_s_weights,&__pyx_n_s_n_jobs,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_means)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("gmm_likelihood", 0, 4, 5, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_covars)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gmm_likelihood", 0, 4, 5, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_weights)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gmm_likelihood", 0, 4, 5, 3); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "gmm_likelihood") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("gmm_likelihood", 0, 4, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("fast_likelihood.gmm_likelihood", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_means), __pyx_ptype_5numpy_ndarray, 1, "means", 0))) __PYX_ERR(0, 11, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_covars), __pyx_ptype_5numpy_ndarray, 1, "covars", 0))) __PYX_ERR(0, 11, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_weights), __pyx_ptype_5numpy_ndarray, 1, "weights", 0))) __PYX_ERR(0, 12, __pyx_L1_error)
  __pyx_r = __pyx_pf_15fast_likelihood_gmm_likelihood(__pyx_self, __pyx_v_X, __pyx_v_means, __pyx_v_covars, __pyx_v_weights, __pyx_v_n_jobs);
...
static PyObject *__pyx_pf_15fast_likelihood_gmm_likelihood(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_means, PyArrayObject *__pyx_v_covars, PyArrayObject *__pyx_v_weights, PyObject *__pyx_v_n_jobs) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_X;
  __Pyx_Buffer __pyx_pybuffer_X;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_covars;
  __Pyx_Buffer __pyx_pybuffer_covars;
  ...
  struct __pyx_opt_args_15fast_likelihood_gmm_likelihood __pyx_t_2;
  __Pyx_RefNannySetupContext("gmm_likelihood", 0);
  __pyx_pybuffer_X.pybuffer.buf = NULL;
  __pyx_pybuffer_X.refcount = 0;
  __pyx_pybuffernd_X.data = NULL;
  ...
  __pyx_t_1 = __pyx_f_15fast_likelihood_gmm_likelihood(__pyx_v_X, __pyx_v_means, __pyx_v_covars, __pyx_v_weights, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"gmm_likelihood", (PyCFunction)__pyx_pw_15fast_likelihood_1gmm_likelihood, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_fast_likelihood(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fast_likelihood},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_Dimension_mismatch_feature_dimen, __pyx_k_Dimension_mismatch_feature_dimen, sizeof(__pyx_k_Dimension_mismatch_feature_dimen), 0, 0, 1, 0},
  {&__pyx_kp_s_Dimension_mismatch_number_of_mix, __pyx_k_Dimension_mismatch_number_of_mix, sizeof(__pyx_k_Dimension_mismatch_number_of_mix), 0, 0, 1, 0},
 ...
 *     if n_mixtures != means.shape[0] or n_mixtures != covars.shape[0]:
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Dimension_mismatch_feature_dimen); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 19, __pyx_L1_error)
 ...
 *     prob = data_logprob_threaded(<double*> X.data, <double*> means.data, <double*> covars.data, <double*> weights.data,
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_Dimension_mismatch_number_of_mix); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 22, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initfast_likelihood(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initfast_likelihood(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_fast_likelihood(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fast_likelihood(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_fast_likelihood(PyObject *__pyx_pyinit_module) CYTHON_SMALL_CODE 
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_fast_likelihood(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("fast_likelihood", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_fast_likelihood) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fast_likelihood")) {
      if (unlikely(PyDict_SetItemString(modules, "fast_likelihood", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fast_likelihood", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fast_likelihood");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
